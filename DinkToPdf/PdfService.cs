...
namespace DinkToPdf
{
    public class PdfService : BackgroundService
    {
        readonly ILogger _logger;
        readonly string ServiceName = nameof(PdfService);
        readonly SynchronizedConverter _converter;
        public PdfService(ILoggerFactory loggerFactory)
        {
